    ...
    $(".img-thumbnail").click(function () {
        ...
        if (numOfGameSelected == 0 && isCircleSelected == false) {
            ...
            if (!$(this).hasClass("img-thumbnail-selected")) {
                ...
                $.each(nested_players, function (index, item) {
                    if (item.key == clickedPlayer) {
                        $("#playerStatsRight").html("<span class='tooltipHeader' style='color:#ddd'>" + "Season Average" + "</span> <hr size='1' style='margin: 3px 0px 6px 0px'>" + "<span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PTS + "</span> <br/> <span class='tooltip-detail-title'> Minutes Played: </span>" + item.values.avg_MP + "</span> <br/> <span class='tooltip-detail-title'> Field Goals: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FG + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FGA + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_FG%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> 3 Points: </span>" + "<span class='tooltip-detail-num'>" + item.values['avg_3P'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values['avg_3PA'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_3P%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Free Throws: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FT + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FTA + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_FT%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Offensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_ORB + "</span> <br/> <span class='tooltip-detail-title'> Defensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_DRB + "</span> <br/> <span class='tooltip-detail-title'> Total Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_TRB + "</span> <br/> <span class='tooltip-detail-title'> Assists: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_AST + "</span> <br/> <span class='tooltip-detail-title'> Steals: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_STL + "</span> <br/> <span class='tooltip-detail-title'> Blockss: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_BLK + "</span> <br/> <span class='tooltip-detail-title'> Turnovers: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_TOV + "</span> <br/> <span class='tooltip-detail-title'> Personal Fouls: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PF + "</span> <br/> <span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PTS + "</span>");
                    };
                });

                console.log(nested_players);
                $.each(nested_players, function (index, item) {
                    if (item.key == clickedPlayer) {
                        $("#playerStatsRight").html("<span class='tooltipHeader' style='color:#ddd'>" + "Season Average" + "</span> <hr size='1' style='margin: 3px 0px 6px 0px'>" + "<span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PTS + "</span> <br/> <span class='tooltip-detail-title'> Minutes Played: </span>" + item.values.avg_MP + "</span> <br/> <span class='tooltip-detail-title'> Field Goals: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FG + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FGA + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_FG%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> 3 Points: </span>" + "<span class='tooltip-detail-num'>" + item.values['avg_3P'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values['avg_3PA'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_3P%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Free Throws: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FT + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FTA + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_FT%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Offensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_ORB + "</span> <br/> <span class='tooltip-detail-title'> Defensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_DRB + "</span> <br/> <span class='tooltip-detail-title'> Total Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_TRB + "</span> <br/> <span class='tooltip-detail-title'> Assists: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_AST + "</span> <br/> <span class='tooltip-detail-title'> Steals: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_STL + "</span> <br/> <span class='tooltip-detail-title'> Blockss: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_BLK + "</span> <br/> <span class='tooltip-detail-title'> Turnovers: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_TOV + "</span> <br/> <span class='tooltip-detail-title'> Personal Fouls: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PF + "</span> <br/> <span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PTS + "</span>");
                    };
...
function calcPlayerStats() {
    d3.csv(teamStarterDataPath, function (oriStarters) {

        d3.csv(teamReserveDataPath, function (oriReserves) {

            gameType = getGameTypeSelectionOption()
            console.log(gameType);
            starters = oriStarters.filter(d => d.GameType == getGameTypeSelectionOption())
            reserves = oriReserves.filter(d => d.GameType == getGameTypeSelectionOption())

            console.log('starters',starters);
            console.log('reserves',reserves);


            var players = starters.concat(reserves)

            console.log(players);
            nested_players = d3.nest()
                ...
                .rollup(function (leaves) {
                    return {
                        ...
                        "avg_FG%": d3.round(d3.mean(leaves, function (e) { return +e.FG; })/d3.mean(leaves, function (e) { return +e.FGA; }), 5),
                        "avg_3P": d3.round(d3.mean(leaves, function (e) { return +e['3P']; }), 1),
                        "avg_3PA": d3.round(d3.mean(leaves, function (e) { return +e['3PA']; }), 1),
                        "avg_3P%": d3.round(d3.mean(leaves, function (e) { return +e['3P']; })/d3.mean(leaves, function (e) { return +e['3PA']; }), 5),
                        "avg_FT": d3.round(d3.mean(leaves, function (e) { return +e['FT']; }), 1),
                        "avg_FTA": d3.round(d3.mean(leaves, function (e) { return +e['FTA']; }), 1),
                        "avg_FT%": d3.round(d3.mean(leaves, function (e) { return +e['FT']; })/d3.mean(leaves, function (e) { return +e['FTA']; }), 5),
...
var playerPositionColorTable = ["#1295B3", "#4D7680", "#2EE6A2", "#E96D69", "#B3124F"];
...
function update() {
    ...
    let season = (getSeasonSelectionOption());
    ...
    if (selectedTeam == "All Teams") {
        allTeamsDataPath = `Data/${season}/data/player-stats-by-team/teamlines.csv`;
        ...
        d3.csv(allTeamsDataPath, function (oriTeams) {
            teams = oriTeams.filter(d => d.GameType == getGameTypeSelectionOption())

            console.log('teams', teams);

            d3.json(`Data/${season}/data/Miami-Heat-2012-2013/miamiPlayersPos.json`, function (playersPos) {
                ...
                var starterCircle = starterItem.append("circle")
                    ...
                    .on("mouseover", function (d) {
                        if (d['Win/Loss'] == "W") {
                            ...
                            tooltipBox.html("<span class='tooltipHeader'>" + d['Date'] + "</span></br>" + "<span class='tooltip-row-name'>Team: </span><span class='tooltip-opponent'>" + d['Team'] + "</span></br>" + "<span class='tooltip-row-name'>Win / Loss: </span><span class='tooltip-loss'>Loss" + "</span></br>" + "<span class='tooltip-row-name'>Opponent: </span><span class='tooltip-opponent'>" + d['Opponent'] + "</span>");
                        }
                        tooltipBox.show();
                        ...
                        if (isCircleSelected == false) {
                            ...
                            $("#playerStatsLeft").html("<span class='tooltipHeader' style='color:#ddd'>" + d.Team + "</span> &nbsp <span class='tooltipHeader' style='color:" + pmColor + "'>" + d['+/-'] + "</span> <hr size='1' style='margin: 3px 0px 6px 0px'>" + "<span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + d.PTS + "</span> <br/> <span class='tooltip-detail-title'> Minutes Played: </span>" + d.MP + "</span> <br/> <span class='tooltip-detail-title'> Field Goals: </span>" + "<span class='tooltip-detail-num'>" + d.FG + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Attempts: </span>" + "<span class='tooltip-detail-num'>" + d.FGA + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(d['FG%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> 3 Points: </span>" + "<span class='tooltip-detail-num'>" + d['3P'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Attempts: </span>" + "<span class='tooltip-detail-num'>" + d['3PA'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(d['3P%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Free Throws: </span>" + "<span class='tooltip-detail-num'>" + d.FT + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Attempts: </span>" + "<span class='tooltip-detail-num'>" + d.FTA + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(d['FT%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Offensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + d.ORB + "</span> <br/> <span class='tooltip-detail-title'> Defensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + d.DRB + "</span> <br/> <span class='tooltip-detail-title'> Total Rebounds: </span>" + "<span class='tooltip-detail-num'>" + d.TRB + "</span> <br/> <span class='tooltip-detail-title'> Assists: </span>" + "<span class='tooltip-detail-num'>" + d.AST + "</span> <br/> <span class='tooltip-detail-title'> Steals: </span>" + "<span class='tooltip-detail-num'>" + d.STL + "</span> <br/> <span class='tooltip-detail-title'> Blockss: </span>" + "<span class='tooltip-detail-num'>" + d.BLK + "</span> <br/> <span class='tooltip-detail-title'> Turnovers: </span>" + "<span class='tooltip-detail-num'>" + d.TOV + "</span> <br/> <span class='tooltip-detail-title'> Personal Fouls: </span>" + "<span class='tooltip-detail-num'>" + d.PF + "</span> <br/> <span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + d.PTS + "</span> <br/> <span class='tooltip-detail-title'> +/-: </span>" + "<span class='tooltip-detail-num'>" + d['+/-'] + "</span>");
                            $.each(nested_players, function (index, item) {
                                if (item.key == d.Name) {
                                    $("#playerStatsRight").html("<span class='tooltipHeader' style='color:#ddd'>" + "Season Average" + "</span> <hr size='1' style='margin: 3px 0px 6px 0px'>" + "<span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PTS + "</span> <br/> <span class='tooltip-detail-title'> Minutes Played: </span>" + item.values.avg_MP + "</span> <br/> <span class='tooltip-detail-title'> Field Goals: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FG + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FGA + "</span> <br/> <span class='tooltip-detail-title'> Field Goal Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_FG%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> 3 Points: </span>" + "<span class='tooltip-detail-num'>" + item.values['avg_3P'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values['avg_3PA'] + "</span> <br/> <span class='tooltip-detail-title'> 3 Point Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_3P%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Free Throws: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FT + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Attempts: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_FTA + "</span> <br/> <span class='tooltip-detail-title'> Free Throw Percentage: </span>" + "<span class='tooltip-detail-num'>" + d3.round(item.values['avg_FT%'] * 100, 1) + "%</span> <br/> <span class='tooltip-detail-title'> Offensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_ORB + "</span> <br/> <span class='tooltip-detail-title'> Defensive Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_DRB + "</span> <br/> <span class='tooltip-detail-title'> Total Rebounds: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_TRB + "</span> <br/> <span class='tooltip-detail-title'> Assists: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_AST + "</span> <br/> <span class='tooltip-detail-title'> Steals: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_STL + "</span> <br/> <span class='tooltip-detail-title'> Blockss: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_BLK + "</span> <br/> <span class='tooltip-detail-title'> Turnovers: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_TOV + "</span> <br/> <span class='tooltip-detail-title'> Personal Fouls: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PF + "</span> <br/> <span class='tooltip-detail-title'> Points: </span>" + "<span class='tooltip-detail-num'>" + item.values.avg_PTS + "</span>");
                                };
        ...
        teamStarterDataPath = `Data/${season}/data/player-stats-by-team/` + selectedTeam + " Starters.csv";
        teamReserveDataPath = `Data/${season}/data/player-stats-by-team/` + selectedTeam + " Reserves.csv";
        teamStatsDataPath = `Data/${season}/data/team-stats/` + selectedTeam + " Team Stats.csv";
        teamPlayersDataPath = `Data/${season}/data/team-players/` + selectedTeam + " Players.json";
                        ...
                        var playerPicDiv = $("#playerPicSection")
                            .append($("<div>")
                                ...
                                .append($("<img>")
                                    ...
                                    .attr("src", function () { return `Data/${season}/images/` + selectedTeam + "/" + item.name + ".jpg"; })
                            ...
                            if (getColorSelectionOption() == "StarterReserve") {
                                ...
                                switch (d["Position"]) {
                                    ...
                                    case "PF":
                                        ...
                                        break;
                                    case "C":
                                        return playerPositionColorTable[4];
                                        break;
                                    default:
                                        return "#f00";
                                }
        ...
        var gameStatsBarChart = d3.select("#gameStatsBarChartVis").append("svg")
            ...
            .attr('viewBox', `0 0 ${width + margin.left + margin.right} ${gameScoreBarHeight + margin.bottom}`)
            .append("g")
            .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
        ...
        //team bar chart
        d3.csv(teamStatsDataPath, function (oriSeletedTeamStats) {
            console.log('selected', oriSeletedTeamStats);

            console.log( getGameTypeSelectionOption()  );


            seletedTeamStats = oriSeletedTeamStats.filter(d => d.GameType == getGameTypeSelectionOption())


            console.log('selected', seletedTeamStats);
...
function getSeasonSelectionOption() {
    var node = d3.select('#yeardropdown').node();
    var i = node.selectedIndex;
    return node[i].value;
}

function getGameTypeSelectionOption() {
    var node = d3.select('#gameTypeDropdown').node();
    var i = node.selectedIndex;
    return node[i].value;
